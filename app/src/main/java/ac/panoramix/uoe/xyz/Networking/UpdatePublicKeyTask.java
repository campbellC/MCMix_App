...
public class UpdatePublicKeyTask extends AsyncTask<String, Integer, String> {
    ...
    protected String doInBackground(String... params) {
        response = mServerHandler.update_key(XYZApplication.getAccount().getKeyPair().getPublicKey());
    ...
    protected void onPostExecute(String s) {
        ...
        if (response == null) {
            Toast.makeText(XYZApplication.getContext(), "Connection down", Toast.LENGTH_LONG).show();
        } else {
            switch (response){
